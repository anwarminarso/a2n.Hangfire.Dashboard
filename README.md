...
| v2.5.1 | ✅ Done | **Nav group crash fix** ([#23](https://github.com/anwarminarso/a2n.Hangfire.Dashboard/issues/23)) — sidebar nav group no longer tears down the Blazor circuit on a fresh session with no saved `localStorage` state |
