...
/// <summary>
/// Shared job catalog used by all sample apps (except SampleAppOrig which uses original Hangfire.Console / FaceIT.Hangfire.Tags packages).
/// Exposes representative jobs for every dashboard scenario: simple, console, tags, failures, progress, and continuation pipelines.
/// </summary>
public class SampleJobs
{
    ...
    // === Continuation pipeline (demonstrates job dependency graph) ===========
